...
module.exports = {
  ...
  plugins: [
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        endpoint:
          "https://midnightboats.us20.list-manage.com/subscribe/post?u=213d39d7d310a4a6b6a295968&id=74a0ef9108", // string; add your MC list endpoint here; see instructions below
